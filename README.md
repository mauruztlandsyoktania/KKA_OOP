...
# Jawaban: Nilai hp dari hero1 akan berubah menjadi 500, sehingga ketika diprint, outputnya akan 500.
...
# jawaban:
# Nilai HP muncul ketika mengakses hero1._Hero__hp karena Python menggunakan
